...
def _matrix_ODE_paper_1atom(t: float, sim_oqs: SimulationModuleOQS) -> Qobj:
    ...
    L[idx_gg, idx_eg] = +1j / HBAR * Et * mu
    L[idx_gg, idx_ge] = -1j / HBAR * Et_conj * mu
    L[idx_ee, idx_ge] = +1j / HBAR * Et_conj * mu
    L[idx_ee, idx_eg] = -1j / HBAR * Et * mu
...
def _matrix_ODE_paper_2atom(t: float, sim_oqs: SimulationModuleOQS) -> Qobj:
    ...
    L[idx_10, idx_00] = 1j * Et * sim_oqs.system.dipole_op[1, 0]
    L[idx_10, idx_11] = -1j * Et * sim_oqs.system.dipole_op[1, 0]
    L[idx_10, idx_12] = -1j * Et * sim_oqs.system.dipole_op[2, 0]
    L[idx_10, idx_30] = 1j * Et_conj * sim_oqs.system.dipole_op[3, 1]
    ...
    L[idx_20, idx_00] = 1j * Et * sim_oqs.system.dipole_op[2, 0]
    L[idx_20, idx_22] = -1j * Et * sim_oqs.system.dipole_op[2, 0]
    L[idx_20, idx_21] = -1j * Et * sim_oqs.system.dipole_op[1, 0]
    L[idx_20, idx_30] = 1j * Et_conj * sim_oqs.system.dipole_op[3, 2]
    ...
    L[idx_30, idx_31] = -1j * Et * sim_oqs.system.dipole_op[1, 0]
    L[idx_30, idx_32] = -1j * Et * sim_oqs.system.dipole_op[2, 0]
    ...
    L[idx_12, idx_32] = 1j * Et_conj * sim_oqs.system.dipole_op[3, 1]
    L[idx_12, idx_10] = -1j * Et_conj * sim_oqs.system.dipole_op[2, 0]
    ...
    L[idx_31, idx_11] = 1j * Et * sim_oqs.system.dipole_op[3, 1]
    L[idx_31, idx_21] = 1j * Et * sim_oqs.system.dipole_op[3, 2]
    L[idx_31, idx_30] = -1j * Et_conj * sim_oqs.system.dipole_op[1, 0]
    ...
    L[idx_32, idx_22] = 1j * Et * sim_oqs.system.dipole_op[3, 2]
    L[idx_32, idx_12] = 1j * Et * sim_oqs.system.dipole_op[3, 1]
    L[idx_32, idx_30] = -1j * Et_conj * sim_oqs.system.dipole_op[2, 0]
    ...
    # 4) Populations
    L[idx_00, idx_01] = -1j * Et * sim_oqs.system.dipole_op[1, 0]
    L[idx_00, idx_02] = -1j * Et * sim_oqs.system.dipole_op[2, 0]
    ...
    L[idx_22, idx_20] = -1j * Et_conj * sim_oqs.system.dipole_op[2, 0]
