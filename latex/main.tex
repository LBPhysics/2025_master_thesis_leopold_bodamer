...
%--------------------------- Define the LIBRARY --------------------------------
%backend=biber,style=numeric,sorting=none,sortcites=true,style=numeric-comp
% actually import stzle with style=customstyle????
\usepackage[backend=biber]{biblatex}
%\renewcommand*{\bibfont}{\small} % Optional: Make the bibliography font size smaller
\addbibresource{bib/my_bibliography.bib}
\addbibresource{bib/spectroscopy_refs.bib}
%\RequireBibliographyStyle{bib/style_bibiliography.bbx}
...
% Custom TODO commands with vibrant colors
