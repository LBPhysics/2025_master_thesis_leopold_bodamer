...
\addbibresource{bib/my_bibliography.bib} % TODO load the bibliography, or how can I connect zotero?
...
%\include{chapters/c02_acknow_lists_abbrs_consts_symbls_dedication__tex} % Corrected chapter path
