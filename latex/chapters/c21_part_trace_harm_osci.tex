% !TEX root = ../main.tex
\chapter{Bath Correlation Functions and Harmonic Oscillator Environments} % Main chapter title

\label{chapter_bath_correlations_harmonic_oscillators} % Label for referencing this chapter
...
\todoidea{compare the  Caldeira–Leggett model to the ???}
