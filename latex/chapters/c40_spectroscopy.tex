...
\noindent In 2DES, the delay time $t_1$ between the first and second pulses is systematically varied, and the signal field is detected in a phase-resolved manner using spectral interferometry \todoref{find ref}%\cite{lepetit1995, bristow2011}. 
